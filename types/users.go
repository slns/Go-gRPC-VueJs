...
type User struct {
	...
	CreatedAt string 	`json:"created_at" xorm:"created_at" schema:"created_at"`
	UpdatedAt string 	`json:"updated_at" xorm:"updated_at" schema:"updated_at"`
}
...
func NewUser(nu *TempUser) (user *User, err error) {
	...
	timeCurrent := time.Now().Format("2006-01-02 15:04:05")
